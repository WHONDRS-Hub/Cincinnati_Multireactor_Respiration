...
colnames(non_linear_fit) = c("Sample_Name","b", "DO_mg_per_L_max", "p_value_a", "p_value_b", "total_incubation_time_min", "R_Squared")
...
unique.incubations = unique(data$Sample_Name)
  ...
  for (j in 1:length(unique.incubations)){
    ...
    rate = as.data.frame(matrix(NA, ncol = 7, nrow = length(unique(data$Sample_Name))))
  
  colnames(rate) = c("Sample_Name","b", "DO_mg_per_L_max", "p_value_a", "p_value_b", "total_incubation_time_min", "R_Squared")
  ...
  AIC(fit_all)  
    ...
    #      subtitle = paste("a =", round(coef_vals[1], 4), ", b =", round(coef_vals[2], 4), ", R2 =", 
    #                       R_Squared),
    #      x = "Elapsed Minute",
    #      y = "DO mg/L") +
    # theme_minimal()
...
setwd("C:/GitHub/Cincinnati_Multireactor_Respiration/Data/Plots/Non_Linear_Fits/")

#ex_pdf = list.files(path = "C:/GitHub/Cincinnati_Multireactor_Respiration/Data/Plots/Non_Linear_Fits/", pattern = "pdf")

ex_pdf = list.files(pattern = "pdf")



pdf_combine(ex_pdf, output = "C:/GitHub/Cincinnati_Multireactor_Respiration/Data/Plots/Non_Linear_Fits/RS_All_Non_Linear_Fits.pdf")
